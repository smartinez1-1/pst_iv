...
--
-- Host: localhost:3306
-- Generation Time: Dec 07, 2023 at 11:42 PM
...
-- Database: `bd_pst`
--
CREATE DATABASE IF NOT EXISTS `bd_pst` DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci;
USE `bd_pst`;
...
--
-- Table structure for table `tutor_comunidad`
--
...
--
-- Indexes for table `categorias_documentos`
--
...
--
-- Indexes for table `tutor_comunidad`
--
...
--
-- Constraints for table `tutor_comunidad`
--
ALTER TABLE `tutor_comunidad`
