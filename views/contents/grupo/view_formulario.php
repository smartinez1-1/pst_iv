                    ...
                    <div class="p-6.5">
                      ...
                      <div class="mb-4.5 w-full flex gap-6 flex-row">
                        ...
                        <div class="w-5/12">
                          ...
                          <input type="text" maxlength="45" minlength="4" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" title="Solo de admiten letras" required placeholder="Ingrese su texto" name="nombre_grupo" value="<?php echo $nombre_grupo; ?>" class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                        </div>
