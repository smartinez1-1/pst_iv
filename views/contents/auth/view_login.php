								...
								<div class="w-full p-4 sm:p-12.5 xl:p-17.5">
									...
									<form action="<?php $this->SetURL("controllers/auth_controller.php");?>" method="POST" autocomplete="off">
										...
										<div class="mb-6">
											...
											<div class="relative">
												<input type="password" required maxlength="12" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" minlength="8" placeholder="8+ Caracteres, 1 mayuscula, 1 numero, 1 caracter especial" name="clave_usuario"
													class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
