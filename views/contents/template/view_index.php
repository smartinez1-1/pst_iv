...
<html lang="en">
  <head>
    ...
    <title>Modals | TailAdmin - Tailwind CSS Admin Dashboard Template</title>
    <link rel="icon" href="favicon.ico" />
    <link href="./views/contents/template/style.css" rel="stylesheet" />
  </head>

  <body
    x-data="{ page: 'Modals', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }"
    x-init="
  ...
  >
      ...
      >
        ...
        <main>
          <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            >
              ...
              <nav>
                <ol class="flex items-center gap-2">
                  ...
                  <li class="font-medium text-primary">Modals</li>
                </ol>
              </nav>
            </div>
            <!-- Breadcrumb End -->
            ...
            <div
              class="rounded-sm border border-stroke bg-white p-10 shadow-default dark:border-strokedark dark:bg-boxdark"
            >
              <div class="flex flex-wrap justify-center gap-5">
                <div x-data="{modalOpen: false}">
                  <button
                    @click="modalOpen = true"
                    class="rounded-md bg-primary py-3 px-9 font-medium text-white"
                  >
                    Modal 1
                  </button>
                  <div
                ...
                <div x-data="{modalOpen: false}">
                  ...
                  >
                    <div
                      @click.outside="modalOpen = false"
                      class="relative w-full max-w-142.5 rounded-lg bg-primary py-12 px-8 text-center md:py-15 md:px-17.5"
                    >
                      <span class="mx-auto inline-block">
                        <svg
                          width="78"
                      ...
                      <h3
                        class="mt-5.5 pb-2 text-xl font-bold text-white sm:text-4xl"
                      >
                        Congratulations!
                      </h3>
                      <span
                      ...
                      <a
                        href="#"
                        class="inline-block rounded border border-white py-3 px-12.5 text-center font-medium text-white transition hover:bg-white hover:text-primary"
                      >
                        Know More
                      </a>
                      <button
                        @click="modalOpen = false"
                        class="absolute top-6 right-6 flex h-7 w-7 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-white hover:text-primary"
                      >
                        <svg
                          width="10"
                          height="10"
    ...
    <script
      ...
      data-cf-beacon='{"rayId":"82645327f8172876","r":1,"version":"2023.10.0","token":"67f7a278e3374824ae6dd92295d38f77"}'
