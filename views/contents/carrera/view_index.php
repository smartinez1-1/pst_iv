                    ...
                    <tr>
                      ...
                      <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                        <p class="text-black dark:text-white">
                          <?php echo ($car['turno_carrera'] == "D") ? "DIURNO" : ""; ?>

                          <?php echo ($car['turno_carrera'] == "N") ? "NOCTURNO" : ""; ?>
                        </p>
                      </td>
                      <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                        <p class="text-black dark:text-white">
                          <?php echo ($car['admite_grupos_mixtos'] == "1") ? "MIXTO" : ""; ?>

                          <?php echo ($car['admite_grupos_mixtos'] == "0") ? "NO MIXTO" : ""; ?>
                        </p>
                      </td>
                      <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
