                  ...
                  <div class="p-6.5">
                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                      <div class="w-full xl:w-2/6">
                        ...
                        <input type="text" placeholder="" name="nombre_comunidad" value="<?php echo $nombre_comunidad;?>"
                      ...
                      <div class="w-full xl:w-2/6">
                        ...
                        <input type="text" placeholder="" name="tipo_comunidad" value="<?php echo $tipo_comunidad;?>"
                          class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                      </div>
                  </div>
                  <div>
                    <div class="mb-6">
                      ...
                      <textarea rows="6" placeholder="Ingrese su Direccion" name="direccion_comunidad" value="<?php echo $direccion_comunidad;?>"
